...
export default function ToolPage() {
  ...
  const handleGenerate = async () => {
    ...
    const mockResults: Record<string, ToolResult> = {
      "seo-audit": {
        score: 78,
        issues: ["Missing meta descriptions", "Slow page load speed", "No alt text on images"],
        recommendations: ["Add meta descriptions", "Optimize images", "Improve page speed"],
        report: "Your website has good SEO fundamentals but needs improvement in technical areas.",
      } as SEOAuditResult,
      "social-media": {
        posts: [
          {
            platform: formData.platform || "Instagram",
            content: `🚀 Discover the power of AI marketing tools! Transform your business with automation that actually works. #AIMarketing #DigitalTransformation #MarketingAutomation`,
            hashtags: ["#AIMarketing", "#DigitalTransformation", "#MarketingAutomation", "#BusinessGrowth"],
          },
        ],
      } as SocialMediaResult,
      "blog-writing": {
        title: formData.title || "AI Marketing Guide",
        content: "# The Ultimate Guide to AI Marketing\n\nAI is revolutionizing marketing...",
        wordCount: 1250,
        seoScore: 85,
      } as BlogWritingResult,
      "email-marketing": {
        subject: formData.subject || "Boost Your Marketing ROI",
        content: "Hi there!\n\nReady to transform your marketing results?...",
        openRate: "24%",
        clickRate: "8%",
      } as EmailMarketingResult,
    }

    setResult(mockResults[toolId] || null)
